        ...
        <section id="connect" className="section-index connect-section">
          ...
          <div className="connect-container">
            <div className="connect-grid">
              <a href="https://github.com/debrupf2946" target="_blank" rel="noopener noreferrer" className="connect-item">
              ...
              <a href="https://www.linkedin.com/in/debrup-paul-599158227/" target="_blank" rel="noopener noreferrer" className="connect-item">
                <div className="connect-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
